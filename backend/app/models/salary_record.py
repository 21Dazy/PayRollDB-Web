...
class SalaryRecord(Base):
    ...
    performance_bonus = Column(DECIMAL(10, 2), default=0, comment='绩效奖金')
    attendance_bonus = Column(DECIMAL(10, 2), default=0, comment='全勤奖')
    transportation_allowance = Column(DECIMAL(10, 2), default=0, comment='交通补贴')
    meal_allowance = Column(DECIMAL(10, 2), default=0, comment='餐补')
    deduction = Column(DECIMAL(10, 2), default=0, comment='扣款')
    social_security = Column(DECIMAL(10, 2), default=0, comment='社保公积金')
    late_deduction = Column(DECIMAL(10, 2), default=0, comment='迟到扣款')
    absence_deduction = Column(DECIMAL(10, 2), default=0, comment='缺勤扣款')
